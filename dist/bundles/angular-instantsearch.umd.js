(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('instantsearch.js/es/connectors'), require('lodash-es'), require('instantsearch.js/es'), require('@angular/common/http'), require('nouislider'), require('algoliasearch/index'), require('querystring-es3/encode'), require('algoliasearch-helper')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'instantsearch.js/es/connectors', 'lodash-es', 'instantsearch.js/es', '@angular/common/http', 'nouislider', 'algoliasearch/index', 'querystring-es3/encode', 'algoliasearch-helper'], factory) :
	(factory((global.ng = global.ng || {}, global.ng.instantsearch = {}),global.ng.core,global.ng.common,global.connectors,global.lodashEs,global.instantsearch,global.http,global.noUiSlider,global.algoliasearchProxy,global.encodeProxy,global.algoliasearchHelper));
}(this, (function (exports,core,common,connectors,lodashEs,instantsearch,http,noUiSlider,algoliasearchProxy,encodeProxy,algoliasearchHelper) { 'use strict';

instantsearch = instantsearch && instantsearch.hasOwnProperty('default') ? instantsearch['default'] : instantsearch;
var algoliasearchProxy__default = algoliasearchProxy['default'];
var encodeProxy__default = encodeProxy['default'];
...
var NgAisBreadcrumb = /** @class */ (function (_super) {
    ...
    function NgAisBreadcrumb(platformId, searchInstance) {
        ...
        _this.state = {
            createURL: lodashEs.noop,
            items: [],
            refine: lodashEs.noop
        };
        return _this;
    }
...
var NgAisBreadcrumbModule = /** @class */ (function () {
    ...
    NgAisBreadcrumbModule.decorators = [
        { type: core.NgModule, args: [{
                    ...
                    imports: [common.CommonModule, NgAisHeaderModule, NgAisFooterModule]
                },] },
    ];
    /** @nocollapse */
...
var NgAisClearRefinements = /** @class */ (function (_super) {
    ...
    function NgAisClearRefinements(platformId, searchInstance) {
        ...
        _this.state = { hasRefinements: false, refine: lodashEs.noop };
        return _this;
    }
...
var NgAisCurrentRefinements = /** @class */ (function (_super) {
    ...
    function NgAisCurrentRefinements(platformId, searchInstance) {
        ...
        _this.state = {
            attributes: {},
            clearAllClick: lodashEs.noop,
            clearAllURL: lodashEs.noop,
            createURL: lodashEs.noop,
            refine: lodashEs.noop,
            refinements: []
        };
    ...
    Object.defineProperty(NgAisCurrentRefinements.prototype, "refinements", {
        get: function () {
            return lodashEs.isFunction(this.transformItems)
    ...
    Object.defineProperty(NgAisHighlight.prototype, "content", {
        get: function () {
            ...
            if (this.hit.hasOwnProperty("_highlightResult")) {
                var attributeHighlighted = lodashEs.get(this.hit._highlightResult, this.attributeName);
                // check that the attributeHighlighted is a string
                if (lodashEs.isPlainObject(attributeHighlighted) &&
                    typeof attributeHighlighted.value === "string") {
                    return this.replaceWithTagName(attributeHighlighted.value);
                }
            }
            var fallback = lodashEs.get(this.hit, this.attributeName);
            if (!fallback) {
...
var NgAisRefinementSelect = /** @class */ (function (_super) {
    ...
    function NgAisRefinementSelect(platformId, searchInstance) {
        ...
        _this.state = {
            ...
            items: [],
            refine: lodashEs.noop,
            toggleShowMore: lodashEs.noop,
            searchForItems: lodashEs.noop,
            isFormSearch: false
        };
        return _this;
    }
    ...
    NgAisRefinementSelect.propDecorators = {
        ...
        'transformItems': [{ type: core.Input },],
        'withSearchBox': [{ type: core.Input },],
        'searchPlaceholder': [{ type: core.Input },],
        'attributeName': [{ type: core.Input },],
        'operator': [{ type: core.Input },],
        'limitMin': [{ type: core.Input },],
        'limitMax': [{ type: core.Input },],
        'sortBy': [{ type: core.Input },],
    };
...
var NgAisResults = /** @class */ (function (_super) {
    ...
    function NgAisResults(plateformId, searchInstance) {
        ...
        _this.updateState = function (state, isFirstRendering) {
            if (isFirstRendering)
                return;
            _this.state = __assign({}, state, { results: state.results, hits: lodashEs.isFunction(_this.transformItems)
...
var NgAisInfiniteResults = /** @class */ (function (_super) {
    ...
    function NgAisInfiniteResults(platformId, searchInstance) {
        ...
        _this.state = {
            hits: [],
            isLastPage: false,
            showMore: lodashEs.noop,
            results: {}
        };
        _this.updateState = function (state, isFirstRendering) {
            if (isFirstRendering)
                return;
            _this.state = __assign$1({}, state, { results: state.results, hits: lodashEs.isFunction(_this.transformItems)
                    ? _this.transformItems(state.hits)
                    : state.hits });
        };
    ...
    Object.defineProperty(NgAisPagination.prototype, "pages", {
        get: function () {
            ...
            if (pagesPadding && pagesPadding > 0) {
                ...
                if (minDelta < 0) {
                    return lodashEs.range(0, currentRefinement + pagesPadding + Math.abs(minDelta));
                }
                if (maxDelta > nbPages) {
                    return lodashEs.range(currentRefinement - pagesPadding - (maxDelta - nbPages), nbPages);
                }
                return lodashEs.range(currentRefinement - pagesPadding, currentRefinement + pagesPadding + 1);
            }
            return pagesArray;
        },
        enumerable: true,
    ...
    function NgAisRangeSlider(platformId, searchInstance) {
        ...
        _this.updateState = function (state, isFirstRendering) {
            if (isFirstRendering) {
                ...
                else if (lodashEs.isPlainObject(_this.pips)) {
...
var NgAisSortBy = /** @class */ (function (_super) {
    ...
    NgAisSortBy.prototype.ngOnInit = function () {
        this.createWidget(connectors.connectSortBySelector, { indices: this.indices });
        _super.prototype.ngOnInit.call(this);
    };
